...
Vue.component('laravel_gallery_system', __webpack_require__(111));
window.$ = __webpack_require__(175);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__gallery__ = __webpack_require__(130);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__back__ = __webpack_require__(157);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__back___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__back__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__image__ = __webpack_require__(162);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__operation__ = __webpack_require__(14);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__generate_loader__ = __webpack_require__(167);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__public_vendor_laravel_gallery_system_js_custome_front_js__ = __webpack_require__(173);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__public_vendor_laravel_gallery_system_js_custome_front_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__public_vendor_laravel_gallery_system_js_custome_front_js__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getGallery: function getGallery(gallery_id) {
            ...
            __WEBPACK_IMPORTED_MODULE_3_axios___default.a.post("/LGS/getGalleryItemFront", { gallery_id: gallery_id }).then(function (response) {
        ...
        setElement: function setElement(event) {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__operation__ = __webpack_require__(14);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        changeLike: function changeLike(encode_id, type, action) {
            ...
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post("/LGS/chnageLike", { encode_id: encode_id, type: type, action: action }).then(function (response) {
                _this.$nextTick(function () {
...
var render = function() {
  ...
  return _c("div", { staticClass: "text-center row" }, [
    _c("div", { staticClass: "col-lg-6 col-sm-6 float-left text-left" }, [
      ...
      _c("span", { staticClass: "ml-1" }, [_vm._v(_vm._s(_vm.item.visit))])
    ]),
    _vm._v(" "),
    _c("div", { staticClass: "col-lg-6 col-sm-6 float-left text-right" }, [
      _c("i", {
        staticClass: "far fa-thumbs-up color_green like pointer",
        on: {
          click: function($event) {
            _vm.changeLike(_vm.item.encode_id, _vm.type, "increament")
          }
        }
      }),
      _c("span", { staticClass: "ml-2" }, [_vm._v(_vm._s(_vm.like))]),
      _vm._v(" "),
      _c("i", {
        staticClass: "far fa-thumbs-down color_red dis_like pointer",
        on: {
          click: function($event) {
            _vm.changeLike(_vm.item.encode_id, _vm.type, "decreament")
          }
        }
      }),
      _c("span", { staticClass: "ml-2" }, [_vm._v(_vm._s(_vm.dis_like))])
    ])
  ])
}
var staticRenderFns = []
        ...
        _vm.item.type == 2
          ? _c("div", { staticClass: "height_225 back_gray" }, [
              _c(
                ...
                _vm._l(_vm.item.encode_file_id, function(file_id) {
                  return _c("source", {
                    attrs: {
                      src: "/LFM/DownloadFile/ID/" + file_id,
                      type: "video/mp4"
                    }
                  })
                })
                  ...
                  [
                    _c("operation", {
                      attrs: {
                        item: _vm.mygallery,
                        type: "gallery",
                        like: _vm.mygallery.like,
                        dis_like: _vm.mygallery.dis_like
                      }
                    })
                  ],
                  1
      ...
      _c(
        ...
        [
          ...
          _vm.showback
            ? _c("back", {
                attrs: {
                  parent_id: _vm.mygallery.parent_id,
